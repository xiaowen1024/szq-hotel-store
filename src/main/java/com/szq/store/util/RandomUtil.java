...
//		System.out.println("返回一个定长的随机纯小写字母字符串(只包含小写字母):"
//				+ generateLowerString(10));
//		System.out.println("返回一个定长的随机纯大写字母字符串(只包含大写字母):"
...
//		int radnum1 = rad.nextInt(10);	// 生成小于 10 的正整数（变化不大）
//		// Math.random() 方法是一个可以产生 [0.0,1.0] 区间内的一个双精度浮点数
//		long radnum2 = Math.round(Math.random() * (255 - 1) + 1);		// 生成最大值为 255，最小值为 1 的随机数
//
//		System.out.println(radnum1);
//		System.out.println(radnum2);
//	}
}