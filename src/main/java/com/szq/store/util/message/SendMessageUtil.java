package com.szq.store.util.message;
...
//替换成你的AK
        final String accessKeyId = "LTAIuK572qfOFVi8";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "T52KlqdbHHCq344ohlHXPVYjMDUkRL";//你的accessKeySecret，参考本文档步骤2
//初始化ascClient,暂时不支持多region（请勿修改）
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("广和");
        //必填:短信模板-可在短信控制台中找到，发送国际/港澳台消息时，请使用国际/港澳台短信模版
        request.setTemplateCode("SMS_146610407");
