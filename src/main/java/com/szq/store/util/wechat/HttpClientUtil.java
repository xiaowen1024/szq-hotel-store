package com.szq.store.util.wechat;
...
public class HttpClientUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        map.put("projectId" , "pangu") ;
        System.out.println("sss" + HttpClientUtil.httpPostRequest("http://127.0.0.1:80/data/updateLatestVersion", map));
    }
}
