...
<section style="background: url(/static/img/bg_team.png);height: 1000px;">
    ...
    <div class="container">
        ...
        <div class="detail">
            <p class="my_order">设置登录密码</p>

            <div class="right_wp">
                <img class="pro_img step step1 " src="/static/img/set_pwd1.png"/>
                <img class="pro_img step step2 dis_none" src="/static/img/set_pwd2.png"/>
                <img class="pro_img step step3 dis_none" src="/static/img/set_pwd3.png"/>
...
<script>
        ...
        if ($(this).data('id') == 1) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    verCode: document.getElementById("yzm").value, type: 2
                },
            ...
            $.ajax({
                ...
                data: {
                    ...
                    confirmPassword: document.getElementById("pwd2").value, type: 2
                },
                url: "/login/setPwd",
                dataType: "json",
                success: function (rs) {
    ...
    $yzm_btn.on("click", function () {
        ...
        $.post("/login/sendCode", {mobile: mobile, type: 2}, function (rs) {
            if (rs.success) {
                settime();
