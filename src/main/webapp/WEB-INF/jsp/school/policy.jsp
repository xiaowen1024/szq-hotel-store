...
<div class="news_bn">
  <div class="wrapp">
    <span class="bread"><a href="/">首页</a> > <a href="/BusinessSchoolDetails/list">广和商学院</a> > 政策解读 </span>
    <a name="zcjd"></a>
  ...
  <section style="background: url('/static/img/bg_team.png') no-repeat center center;background-position: bottom; " >
    ...
    <div class="news_page_wrapp">
      <p align="center" style="font-size: 36px;">政策解读</p>
      <div class="line"></div>
      <p align="center" style="font-size: 26px;">Policy interpretation</p>
...
<script>
  ...
  function getdata(cur,size){
    ...
    $.getJSON("/PolicyInterpreTation/list?pageNo="+cur+"&pageSize="+size,function(rs){
