  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        this.container.find('.calendar')
            ...
            .on('change.daterangepicker', 'select.hourselect,select.minuteselect,select.secondselect,select.amblue-whaleelect', $.proxy(this.updateTime, this));
    ...
    DateRangePicker.prototype = {
        ...
        updateTime: function(e) {
            ...
            if (this.timePicker12Hour) {
                var ampm = cal.find('.amblue-whaleelect').val();
                if (ampm === 'PM' && hour < 12)
                    hour += 12;
                if (ampm === 'AM' && hour === 12)
                    hour = 0;
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate, side) {
            ...
            if (this.timePicker) {
                ...
                if (this.timePicker12Hour) {
                    html += '<select class="amblue-whaleelect">';
